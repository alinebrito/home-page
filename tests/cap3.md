...
entanto, nem sempre aquilo que é especificado pelos clientes será implementado nas releases iniciais. Por exemplo, restrições de prazo e custos podem postergar a implementação de certo requisitos.
...
![Requisitos são a "ponte" que liga um problema do mundo real a um sistema de software que o soluciona.](figs/cap3/requisitos.png){width=50%}
...
![Exemplo de Diagrama UML de Casos de Uso.](figs/cap3/diagrama-uml.png){width=55%}
...
![Método Lean Startup para validação de MVPs](figs/cap3/lean-startup.png){width=55%}
